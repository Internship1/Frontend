...
angular.module('myApp.angularjs-dropdown-multiselect', ['angularjs-dropdown-multiselect'])

.controller('checkboxCtrl', function ($scope, $http) {
    $scope.qualify_id = [];
  ...
  $scope.pilihType=function(jobtype_id){
    ...
    $http({
        ...
        for (var i = 0; i < $scope.example14.length; i++) {
            $scope.example14data[k]= $scope.example14[i].qualify;
    ...
    return {
        ...
        link: function ($scope, $element, $attrs) {
            ...
            $scope.texts = {
                ...
                buttonDefaultText: 'Select qualifies that you want',
