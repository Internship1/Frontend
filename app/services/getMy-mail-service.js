...
.controller('getMyMailCtrl', function($scope, $http, $route) {
	...
	var inboxUrl = 'http://192.168.0.16:8080/api/inbox/';
	var outboxUrl = 'http://192.168.0.16:8080/api/outbox/';
	...
	$http({
		method: "GET",
		url: 'http://192.168.0.16:8080/api/users/all'
	}).then(function successCallBack(response) {
	...
	//for (var i = 0; i < $scope.itemList.length;  i++) {
		...
		var decoded = jwt_decode(tokenBearer);
		var userEndPoint = decoded.sub;
		var sendMailUrl = 'http://192.168.0.16:8080/api/outbox/store';
		for (var i = 0; i < $scope.itemList.length;  i++) {
		var data = {
	...
	$scope.deleteInbox = function(id){
		...
		var urlDelete = 'http://192.168.0.16:8080/api/inbox/';
		var hapus = "/delete";
		var id=id;
	...
	$scope.deleteOutbox = function(id){
		...
		var urloutbox = 'http://192.168.0.16:8080/api/outbox/';
		var hapus = "/delete";
		var id=id;
