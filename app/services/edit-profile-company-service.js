...
.controller('editCompanyProfileServiceCtrl',  function($scope, $http) {
	...
	var userEditCompanyProfileUrl = 'http://192.168.0.11:8080/api/companies/';
	var perintah= "/update"
	...
	$scope.editCompanyProfile = function(company_name, company_contact, company_address, company_email, company_website,company_description,company_logo) {
		...
		// call service
		//$http.put('http://192.168.0.11:8080/api/usersProfile/{user_id}/update', JSON.stringify(data)).then(function(response) {
			//if(response.data)
